...
<body>
	<div id="wrap">
		<div class="header">
			<h1>
				<a href="https://www.naver.com" class="h_logo"> <img src="">
				</a>
			</h1>
		</div>
		<div class="main">
			<div class="agreeForm">
				<form action="_03_join.jsp">
					<ul class="ul1">
						<input type="checkbox" name="parents" onclick="allChk(this)">
						<span> 네이버 이용약관, 개인정보 수집 및 이용, 위치정보 이용약관(선택), 프로모션 정보
							수신(선택)에 모두 동의합니다. </span>
						<li><input type="checkbox" name="required" class="child">
							<span> 네이버 이용약관 동의 <span id=essen> (필수) </span>
						</span> <br> <textarea style="resize: none;" readonly>여러분을 환영합니다.
						...
						<li><input type="checkbox" name="required" class="child">
							<span> 개인정보 수집 및 이용 동의 <span id=essen> (필수) </span>
						</span> <br> <textarea style="resize: none;" readonly></textarea></li>
						<li><input type="checkbox" name="option" class="child">
							<span> 위치정보 이용약관 동의 (선택) </span> <br> <textarea
								style="resize: none;" readonly></textarea></li>
						<li><input type="checkbox" name="option" class="child">
							<span> 프로모션 정보 수신 동의 (선택) </span> <br> <br> <span
							id="etc">네이버에서 제공하는 이벤트/혜택 등 다양한 정보를 휴대전화(네이버앱 알림 또는 문자),
								이메일로 받아보실 수 있습니다. 일부 서비스(별도 회원 체계로 운영하거나 네이버 가입 이후 추가 가입하여 이용하는
								서비스 등)의 경우, 개별 서비스에 대해 별도 수신 동의를 받을 수 있으며, 이때에도 수신 동의에 대해 별도로
								안내하고 동의를 받습니다.</span></li>
						<span class="error"
							style="display: none; color: red; font-size: 0.75em;"> <br>네이버
							이용약관과 개인정보 수집 및 이용에 대한 안내 모두 동의해주세요.
						</span>
					</ul>
					<div class="btns">
						<button class="btn" id="btn1" type="button"
							onclick="location.href='http://www.naver.com/'">취소</button>

						<input class="btn" id="btn2" type="button"
							onclick="agreeChk(form)" value="확인">

...
%>
    ...
    <input name="code" type="hidden" value="<%=code%>">
        ...
        <div class ="floor">
            <input class = "btn1" type="button" onclick="location.href='_18_boardView.jsp?code=<%=code %>'" value="취소">
            <input class = "btn2" type="button" onclick="checkInfo(form)" value="수정">
        </div>
	</form>
	
	<script>
	$('input[name=title]').attr('value',"<%=temp.getTitle()%>");
	$('textarea[name=content]').text("<%=temp.getContent()%>");
